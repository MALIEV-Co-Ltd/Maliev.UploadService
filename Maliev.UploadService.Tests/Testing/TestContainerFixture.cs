...
{
    public static readonly PostgreSqlContainer PostgresContainer = new PostgreSqlBuilder().WithName("postgres:18-alpine")
        .WithCommand("-c", "max_connections=1000")
        .Build();

    public static readonly RedisContainer RedisContainer = new RedisBuilder().WithName("redis:8.4-alpine")
        .Build();

    public static readonly RabbitMqContainer RabbitMqContainer = new RabbitMqBuilder().WithName("rabbitmq:4.2-alpine")
        .Build();
